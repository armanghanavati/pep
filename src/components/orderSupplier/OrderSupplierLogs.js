...
class OrderSupplierLogs extends React.Component{
    constructor(props){
        super(props);
        this.state={}
    }
    ...
    renderTableLogsModalData() {
        let LOGS=this.props.LogsOrderPointSupplier.LogsOfOPS;
        if(LOGS==null)
            LOGS=[]
...
const mapStateToProps = (state) => ({
  ...
  export default connect(mapStateToProps)(OrderSupplierLogs);