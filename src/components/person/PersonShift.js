...
//         <label>برای شیفت صبح عدد 1 و برای شیفت بعد از ظهر عدد 2 را وارد کنید</label>
//         <textarea onChange={(e) => { this.handleChange(e) }} placeholder='شیفت' style={{ marginRight: "20px", width: "400px", marginTop: "40px" }} />
//       </div>
//     )
//   };
