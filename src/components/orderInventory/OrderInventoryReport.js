...
class OrderInventoryReport extends React.Component {
  constructor(props) {
    super(props);    
    this.state = {
      stateWait: false,      
  ...
  btnSearch_onClick = async () => {
    ...
    this.setState({
      OrderInventoryGridData: await orderPointInventoryReport(
        OBJ,
        this.props.User.token
      ),
    });
...
export default connect(mapStateToProps)(OrderInventoryReport);
