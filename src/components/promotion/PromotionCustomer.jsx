...
import SwitchCase from "../../components/common/SwitchCases/SwitchCase";
    ...
    <Col className={className} xxl={xxl} xs={xs} md={md} xl={xl}>
      ...
      >
        <span className="font15 mt-1">
          {selectStore?.length !== 0 && selectStore?.length !== undefined
            ? `${selectStore?.length} ${label} انتخاب شد`
            : ""}
        </span>
        <span>
                    ...
                    return (
                      <tr key={item.id}>
                        ...
                        <td className="fitTable">
                          <div className="">{item?.customerGroupName}</div>
                        </td>
                        <td className="fitTable">
                          <div className="my-1">
                            <SwitchCase
