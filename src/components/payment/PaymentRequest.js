...
import {sEPPaymentList, addSEPPayment, updateSEPPayment} from '../../redux/reducers/payment/payment-action'
          ...
          <Row style={{ padding: '10px' }}>
              <Col>
                  <Button variant="contained"
                      ...
                      onClick={this.btnOnclick_NewSEPPayment}
                  >
                      جدید
                  </Button>
              </Col>
          ...
          {!this.state.stateUpdateDelete?(
                                    <Row style={{ padding: '10px', direction: 'rtl' }}>
                                        <Col xs="auto">
                                            <Button variant="contained"
                                                sx={{ fontFamily: 'Tahoma', marginTop: '10px' }}
                                                onClick={this.onClick_AddSEPPayment}
                                            >
                                                ثبت درخواست پرداخت
                                            </Button>
                                        </Col>                        
