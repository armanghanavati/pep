...
import { userLocationListCombo } from "../../redux/reducers/user/user-actions";
import { DataGridSnpOrderReportColumns } from "./SnpOrderReport-config";
import {
...
import { snpOrderReport } from "../../redux/reducers/snapp/snpOrder-actions";

const dateLabel = { 'aria-label': 'Date' };

class SnpOrderReport extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            stateWait: false,
    ...
    btnSearch_onClick = async () => {
        ...
        this.setState({
            SnpOrderReportGridData: await snpOrderReport(
                OBJ,
                this.props.User.token
            ),
        });
    ...
    btnExportExcel_onClick = () => {
        Gfn_ExportToExcel(this.state.SnpOrderReportGridData, "SnpOrderReport")
    }
        ...
        return (
            <div className="standardMargin" style={{ direction: "rtl" }}>
                ...
                <Card className="shadow bg-white border pointer">
                    <Row className="standardPadding">
                        <Row>
                            <Label className="title">گزارش فروش</Label>
                        </Row>
                        ...
                        <Row className="standardSpaceTop">
                            <Col xs="auto" className="standardMarginRight">
                                <DataGrid
                                    id="grdSnpOrderReport"
                                    dataSource={this.state.SnpOrderReportGridData}
                                    defaultColumns={DataGridSnpOrderReportColumns}
                                    keyExpr="id"
...
export default connect(mapStateToProps)(SnpOrderReport);
